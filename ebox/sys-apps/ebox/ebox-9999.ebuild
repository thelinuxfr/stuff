...
ESVN_REPO_URI="http://svn.ebox-platform.com/ebox-platform/branches/${PV}/client/${PN}"
...
pkg_setup(){
	## Add user and group
	enewgroup ebox
        enewuser ebox -1 -1 /var/lib/ebox "ebox,adm"
...
src_compile() {
	...
	econf --disable-runtime-tests --disable-schemas-install || die "Configure failed"
