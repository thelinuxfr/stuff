...
MY_P="network-manager-applet-${PV}"
...
src_unpack() {
	unpack ${A}
	cd "${S}"
	epatch "${FILESDIR}/nm-applet-0.7.1-confchanges-dbus-126.patch"
	epatch "${FILESDIR}/nm-applet-0.7.1-confchanges-pre-dbus-126.patch"
	epatch "${FILESDIR}/add_libmbca_support.patch"
}
